  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl sm:text-2xl font-bold text-stone-900 tracking-tight">分享图设置</h1>
        <button
          onClick={() => load()}
      ...
      <p className="text-sm text-stone-500">保存到 Supabase，仅对「只导出正面」且使用赠送积分生成的分享图生效。</p>
        ...
        {row && (
          <>
            ...
            <div className="space-y-1">
              <div className="text-xs text-stone-500 uppercase tracking-wider">品牌文字</div>
              <input
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <div className="text-xs text-stone-500 uppercase tracking-wider">透明度（0-1）</div>
                <input
                  type="number"
                  step="0.05"
                  min="0"
              ...
              <div className="space-y-1">
                <div className="text-xs text-stone-500 uppercase tracking-wider">尺寸比例</div>
                <input
                  type="number"
                  step="0.001"
                  min="0.005"
