...
const translations: Record<string, any> = {
  en: {
    ...
    aiBackDesc: 'Fast mode: generate the message and layout first. The AI decorative back image is generated on demand in the editor.',
  ...
  zh: {
    ...
    aiBack: 'AI 背面模板',
    aiBackDesc: '快速模式：先生成背面文案和自动模板，AI 背面装饰图可在编辑页按需生成。',
    backDesign: '背面设计',
    backNone: '仅正面（不生成背面）',
    backTemplate: '固定模板背面',
    backAi: 'AI 背面（快速）',
